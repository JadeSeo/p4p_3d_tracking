...
: ${AMENT_CURRENT_PREFIX:="/home/jetson/p4p/install/tm_moveit_config_tm5x-900"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/tm_moveit_config_tm5x-900/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/tm_moveit_config_tm5x-900/environment/path.sh"
